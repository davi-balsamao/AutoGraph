          ...
          children: [
            Text('Usuários',
                style: GoogleFonts.inter(
                    ...
                    color: textColor)),
            Text('${_filtered.length} cadastrados · 96% no agente',
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                _KpiChip('TOTAL', '${_filtered.length}', mutedColor,
                    textColor, borderColor, surfaceBg),
                const SizedBox(width: 8),
                _KpiChip('VIP', '18', AGColors.accentPurple,
                    textColor, borderColor, surfaceBg),
                const SizedBox(width: 8),
                _KpiChip('FREQUENTE', '64', AGColors.brandGreenMid,
                    textColor, borderColor, surfaceBg),
              ],
            ),
          ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    // Badge VIP/Frequente/Regular (mock)
