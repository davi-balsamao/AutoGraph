...
// Copie este arquivo para `lib/core/theme/ag_tokens.dart` no projeto Flutter.
//
// Uso:
//   Container(
...
class AGType {
  ...
  static TextStyle get buttonMd => GoogleFonts.inter(
        fontSize: 14, fontWeight: FontWeight.w600, height: 1.30,
      );
...
// ─────────────────────────────────────────────────────────────
// FULL THEME — copie/cole no MaterialApp(theme: ...)
// ─────────────────────────────────────────────────────────────
class AGTheme {
  AGTheme._();
