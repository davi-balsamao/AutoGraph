 ...
 */
exports.RAG_SYSTEM_PROMPT = `Você é o Assistente de Triagem da Gráfica AutoGraph. Sua função é descobrir qual produto o cliente deseja e fazer as perguntas necessárias para montar a Ordem de Serviço (OS), com base nas regras fornecidas nos documentos abaixo.
 ...
 */
exports.RAG_HUMAN_PROMPT = `As informações abaixo, delimitadas por "+++++", representam a entrada enviada pelo cliente.
