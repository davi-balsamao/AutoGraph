/**
 * Teste E2E: Fluxo 16 · Exigência de desconto além da margem
 * Baseado no fluxo: backend/rag-test/fluxos/fluxo16.md
 */
...
describe('Fluxo: fluxo16', () => {
  ...
  it('deve processar O FLUXO COMPLETO (8 passos)', async () => {
  ...
  }, 130000); // Timeout dinâmico baseado no número de passos
