/**
 * Teste E2E: Fluxo 9 · Formato de arquivo incompatível
 * Baseado no fluxo: backend/rag-test/fluxos/fluxo9.md
 */
...
describe('Fluxo: fluxo9', () => {
  ...
  it('deve processar O FLUXO COMPLETO (13 passos)', async () => {
    ...
    // Passo 4: Validar arq. ❌ fmt
    await sendMessage(testNumber, testName, 'Simulando cliente avançando no passo: Validar arq. ❌ fmt');
    await new Promise(r => setTimeout(r, 8000)); // Espera processamento IA
