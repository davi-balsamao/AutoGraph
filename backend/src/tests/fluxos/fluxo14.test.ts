/**
 * Teste E2E: Fluxo 14 · Ambiguidade impede identificar o produto
 * Baseado no fluxo: backend/rag-test/fluxos/fluxo14.md
 */
...
describe('Fluxo: fluxo14', () => {
  ...
  it('deve processar O FLUXO COMPLETO (11 passos)', async () => {
    ...
    // Passo 2: Identificar clarificar
    await sendMessage(testNumber, testName, 'Simulando cliente avançando no passo: Identificar clarificar');
    await new Promise(r => setTimeout(r, 8000)); // Espera processamento IA
