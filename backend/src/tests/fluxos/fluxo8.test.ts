/**
 * Teste E2E: Fluxo 8 · Ciclo completo sem conversão
 * Baseado no fluxo: backend/rag-test/fluxos/fluxo8.md
 */
...
describe('Fluxo: fluxo8', () => {
  ...
  it('deve processar O FLUXO COMPLETO (7 passos)', async () => {
    ...
    // Passo 6: Aguardar aprov. recusa
    await sendMessage(testNumber, testName, 'Simulando cliente avançando no passo: Aguardar aprov. recusa');
    await new Promise(r => setTimeout(r, 8000)); // Espera processamento IA
  ...
  }, 115000); // Timeout dinâmico baseado no número de passos
