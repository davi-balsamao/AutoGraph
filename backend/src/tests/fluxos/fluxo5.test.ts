/**
 * Teste E2E: Fluxo 5 · Atalho que quebra a ordem natural
 * Baseado no fluxo: backend/rag-test/fluxos/fluxo5.md
 */
...
describe('Fluxo: fluxo5', () => {
  ...
  it('deve processar O FLUXO COMPLETO (11 passos)', async () => {
    ...
    // Passo 3: Esclarecer preço?
    await sendMessage(testNumber, testName, 'Simulando cliente avançando no passo: Esclarecer preço?');
    await new Promise(r => setTimeout(r, 8000)); // Espera processamento IA
