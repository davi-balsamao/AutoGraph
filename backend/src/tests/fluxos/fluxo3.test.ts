/**
 * Teste E2E: Fluxo 3 · Arquivo enviado em baixa resolução
 * Baseado no fluxo: backend/rag-test/fluxos/fluxo3.md
 */
...
describe('Fluxo: fluxo3', () => {
  ...
  it('deve processar O FLUXO COMPLETO (13 passos)', async () => {
    ...
    // Passo 4: Validar arq. ❌ dpi
    await sendMessage(testNumber, testName, 'Simulando cliente avançando no passo: Validar arq. ❌ dpi');
    await new Promise(r => setTimeout(r, 8000)); // Espera processamento IA
  ...
  }, 205000); // Timeout dinâmico baseado no número de passos
