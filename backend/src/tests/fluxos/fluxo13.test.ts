/**
 * Teste E2E: Fluxo 13 · Ausência de histórico acessível
 * Baseado no fluxo: backend/rag-test/fluxos/fluxo13.md
 */
...
describe('Fluxo: fluxo13', () => {
  ...
  it('deve processar O FLUXO COMPLETO (11 passos)', async () => {
    ...
    // Passo 3: Coletar specs re-coletar
    await sendMessage(testNumber, testName, 'Simulando cliente avançando no passo: Coletar specs re-coletar');
    await new Promise(r => setTimeout(r, 8000)); // Espera processamento IA
