/**
 * Teste E2E: Fluxo 6 · Interrupção e reengajamento tardio
 * Baseado no fluxo: backend/rag-test/fluxos/fluxo6.md
 */
...
describe('Fluxo: fluxo6', () => {
  ...
  it('deve processar O FLUXO COMPLETO (13 passos)', async () => {
    ...
    // Passo 4: Ag. retorno
    await sendMessage(testNumber, testName, 'Simulando cliente avançando no passo: Ag. retorno');
    await new Promise(r => setTimeout(r, 8000)); // Espera processamento IA
